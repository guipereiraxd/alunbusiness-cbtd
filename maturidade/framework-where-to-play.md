...
┌─────────────────────────────────────────────────────────┐
│                  ASPIRAÇÃO VENCEDORA                     │
│          O objetivo que alinha esforços e motiva         │
└───────────────────────┬─────────────────────────────────┘
                        │
         ┌──────────────┴──────────────┐
         ▼                             ▼
...
│  Territórios    │           │  Como ganhar    │
│  da estratégia  │           │  o jogo         │
└────────┬────────┘           └────────┬────────┘
         │                             │
         └──────────────┬──────────────┘
                        │
...
## O mapa de Competências por Territórios

A palestra apresenta um framework de ambidestria organizacional que conecta mercados e competências em 9 territórios estratégicos:

|  | Mercados já estabelecidos | Mercados existentes não endereçados | Novos mercados para explorar |
|---|---|---|---|
| **Competências já dominadas** | T1: Escalar | T2: Escalar | T3: Escalar |
| **Competências existentes não usadas** | T4: Dominar | T5: Dominar | T6: Dominar |
| **Novas competências exigidas** | T7: Experimentar | T8: Experimentar | T9: Experimentar |

**Como usar:**

- **Territórios T1–T3 (Escalar Competências):** foco no core business — otimização, eficiência, excelência operacional. T&D atua em upskilling.
- **Territórios T4–T6 (Dominar Competências):** mercados adjacentes — competências existentes sendo aplicadas em novos contextos. T&D atua em reskilling.
- **Territórios T7–T9 (Experimentar Competências):** novos mercados — competências que ainda não existem na organização. T&D atua em exploração e inovação de aprendizagem.

**As três táticas possíveis:**
- **Incremental:** esforço concentrado no core business e competências adjacentes
- **Balanceada:** contempla exploração de novos modelos com apostas em territórios definidos
- **Disruptiva:** desenvolvimento e exploração de novas competências para novos mercados
