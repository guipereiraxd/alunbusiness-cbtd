...
<div class="wrap">
  <div class="page-head">
    ...
    <p class="lede">Onde a IA gera valor no setor público — organizado por área. Cada frente reúne casos de uso, benefícios e riscos, para você começar pelo que é mais próximo da sua realidade.</p>
    <nav class="area-nav" aria-label="Áreas">
  ...
  <section class="blk" id="atendimento" style="scroll-margin-top:90px">
    ...
    <div class="trio">
      ...
      <div style="--trc:var(--alr)"><h4>Riscos</h4><ul><li>Respostas incorretas</li><li>Exclusão digital</li><li>Tratamento inadequado de dados</li><li>Falta de canal humano</li><li>Orientações desatualizadas</li></ul></div>
    </div>
    <a class="panel-link" href="{{ '/setorpublico/casos/' | relative_url }}?area=Atendimento ao cidadão"><div><div class="k">Casos</div><h3>Ver casos de atendimento ao cidadão</h3></div><span class="cta">Abrir →</span></a>
  </section>
  ...
  <section class="blk" id="processos" style="scroll-margin-top:90px">
    ...
    <div class="trio">
      ...
      <div style="--trc:var(--alr)"><h4>Riscos</h4><ul><li>Uso de documentos sigilosos</li><li>Erros de interpretação</li><li>Perda de contexto</li><li>Automação sem revisão</li></ul></div>
    </div>
    <a class="panel-link" href="{{ '/setorpublico/casos/' | relative_url }}?area=Processos administrativos"><div><div class="k">Casos</div><h3>Ver casos de processos administrativos</h3></div><span class="cta">Abrir →</span></a>
  </section>
  ...
  <section class="blk" id="compras" style="scroll-margin-top:90px">
    ...
    <div class="trio">
      ...
      <div style="--trc:var(--alr)"><h4>Riscos</h4><ul><li>Dependência de fornecedor</li><li>Dados comerciais sensíveis</li><li>Recomendações enviesadas</li><li>Falta de auditabilidade</li></ul></div>
    </div>
    <a class="panel-link" href="{{ '/setorpublico/casos/' | relative_url }}?area=Compras e contratos"><div><div class="k">Casos</div><h3>Ver casos de compras e contratos</h3></div><span class="cta">Abrir →</span></a>
  </section>
  ...
  <section class="blk" id="controle" style="scroll-margin-top:90px">
    ...
    <div class="trio">
      ...
      <div style="--trc:var(--alr)"><h4>Riscos</h4><ul><li>Falsos positivos</li><li>Falta de explicabilidade</li><li>Viés histórico</li><li>Impactos reputacionais</li></ul></div>
    </div>
    <a class="panel-link" href="{{ '/setorpublico/casos/' | relative_url }}?area=Controle e auditoria"><div><div class="k">Casos</div><h3>Ver casos de controle e auditoria</h3></div><span class="cta">Abrir →</span></a>
  </section>
  ...
  <section class="blk" id="politicas" style="scroll-margin-top:90px">
    ...
    <div class="trio">
      ...
      <div style="--trc:var(--alr)"><h4>Riscos</h4><ul><li>Dados incompletos</li><li>Modelos inadequados</li><li>Confusão entre correlação e causalidade</li><li>Recomendações sem contexto social</li></ul></div>
    </div>
    <a class="panel-link" href="{{ '/setorpublico/casos/' | relative_url }}?area=Formulação de políticas"><div><div class="k">Casos</div><h3>Ver casos de formulação de políticas</h3></div><span class="cta">Abrir →</span></a>
  </section>
  ...
  <section class="blk" id="pessoas" style="scroll-margin-top:90px;border-bottom:0">
    ...
    <div class="trio">
      ...
      <div style="--trc:var(--alr)"><h4>Riscos</h4><ul><li>Uso inadequado de dados pessoais</li><li>Avaliações automatizadas</li><li>Discriminação</li><li>Falta de transparência</li></ul></div>
    </div>
